...
class Processor():
    ...
    def load_weights(self):
        if self.args.weights:
            ...
            model_dict = list(self.model.state_dict())[:-6]
    ...
    def train(self):
        ...
        for data, label in loader:
            ...
            with open(self.args.save_save_output, "a") as f:
    ...
    def start(self):
        ...
        if self.args.phase == 'train' or self.args.phase == "recogn":
            ...
            self.optimizer = optim.SGD([{"params": self.model.module.alexnet.parameters()},
                                        {"params": self.model.module.classifier.parameters(), "lr": 1e-1}], lr=1e-2)
            #self.optimizer = optim.SGD(self.model.module.classifier.parameters(), lr = 1e-2)
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--save_weights', default='supervised/epoch{}_model.pt', help='save_weights')
        parser.add_argument('--eval_interval', type=int, default=5, help='eval_interval')
        parser.add_argument('--start_epoch', type=int, default=0, help='start training from which epoch')
        parser.add_argument('--num_epoch', type=int, default=1000, help='stop training in which epoch')
        parser.add_argument('--gpus', type=list, default=[0], help='the indexes of GPUs for training or testing')
        parser.add_argument('--clip_gradient', type=int, default=100, help='clip_gradient')



        # dataset
        parser.add_argument('--root_file', default='/mnt/Action2/UCF-101-JPG', help='root file')
        parser.add_argument('--train_list', default='/mnt/Action2/linlilang/PKUMMD-Skeleton/PKUMMD_2/xview/M/train_data.npy', help='train list file')
        parser.add_argument('--test_list', default='/mnt/Action2/linlilang/PKUMMD-Skeleton/PKUMMD_2/xview/M/val_data.npy', help='test list file')
        parser.add_argument('--train_label', default='/mnt/Action2/linlilang/PKUMMD-Skeleton/PKUMMD_2/xview/M/train_label.pkl', help='train list file')
        parser.add_argument('--test_label', default='/mnt/Action2/linlilang/PKUMMD-Skeleton/PKUMMD_2/xview/M/val_label.pkl', help='train list file')
        ...
        # models
        parser.add_argument('--weights', default="out_file/epoch180_model.pt", help='the weights for network initialization')
